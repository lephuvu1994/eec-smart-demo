 ...
 * @example
 * const devices = await gladys.device.getListDeviceFeatureByRoomId('room-id');
 */
async function getListDeviceFeatureByRoomId(roomId, options) {
