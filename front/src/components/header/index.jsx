...
const Header = ({ ...props }) => {
  ...
  return (
    <div>
      <div class={cx('header', 'p-0', style.header_fix)}>
        <div class="container-fluid">
          <div class="d-flex align-items-center">
            ...
            <div class={cx('header', 'collapse', 'd-lg-flex', 'p-0')} id="headerMenuCollapse">
      ...
      <div
        class={cx('header', 'p-0', 'collapse', 'd-lg-none', { show: props.showCollapsedMenu })}
